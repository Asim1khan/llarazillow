<template>
    <form @submit.prevent="filter">
        <div class="mb-8 mt-4 flex flex-wrap gap-2">
            ...
            <div class="flex flex-nowrap items-center">
                <input type="text"  v-model.number="filterForm.areaFrom" placeholder="Area From" class="input-filter-l w=28" />
                <input type="text" v-model.number="filterForm.areaTo" placeholder="Area To" class="input-filter-r w-28"  />
